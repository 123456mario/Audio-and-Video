...
def main():
    global sock_osc
    logger.info("🚀 STARTING BRIDGE v3.9 (Mute Integer Fix)")
            ...
            try:
                ...
                if osc_addr in POLL_TARGETS:
                    ...
                    if comma_idx != -1:
                        ...
                        # CRITICAL FIX: If address is mute, FORCE INTEGER PARSING
                        if "mute" in osc_addr:
                            # Wing sends ,sfi tags, but the last 4 bytes are the integer value (1 or 0)
