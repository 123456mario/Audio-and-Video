    ...
    try:
        ...
        # Channel Mute (CHM)
            ...
            try:
                ...
                if ch:
                    ...
                    osc_val = 1.0 if is_on else 0.0 # Use Float for Wing
            except: pass
        ...
        # Main Mute
            ...
            try:
                ...
                osc_val = 1.0 if is_on else 0.0 # Use Float
            except: pass
        ...
        if osc_addr and sock_osc:
            ...
            # Use FLOAT for both fadr and mute
            # This ensures compatibility if Wing expects float mutes
            osc_data += b",f\0\0"
...
def main():
    global sock_osc
    logger.info("🚀 STARTING BRIDGE v4.0 (Float Mute Send)")
            ...
            try:
                ...
                if osc_addr in POLL_TARGETS:
                    ...
                    if comma_idx != -1:
                        ...
                        # FORCE INTEGER PARSING for Mute Feedback (Reliable)
                        if "mute" in osc_addr:
                        ...
                        if is_change:
                            ...
                            if "/fdr" in osc_addr:
                                ...
                                # Wing: 1 = ON, 0 = OFF (even if huge int from float, >0 is ON)
                                is_on = (val >= 1)
